 ...
 * @author RLB
 */
public class FormBeliPasir extends javax.swing.JFrame {
    ...
    String namapasir, wangi, id;
    DecimalFormat df = new DecimalFormat();

    /**
     * Creates new form FormBeli
     */
    public FormBeliPasir() {
        initComponents();
        autoID();
    }
    ...
    private void autoID() {
        try {
            sql = "SELECT * FROM pasir ORDER BY id DESC";
    ...
    private void selesai() {
        ...
        try {
            sql = "INSERT INTO pasir VALUES" + "('" + id + "','" + namapasir + "','" + jumlahbeli + "','" + wangi + "', '" + hargasatuan + "', '" + formatharga + "', '" + total + "')";
            st = conn.createStatement();
            st.execute(sql);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBeliPasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBeliPasir().setVisible(true);
            }
        });
    }
